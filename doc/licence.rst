...
Then following people (listed in alphabetical order) contributed to |synaptiks|.

.. when adding contributors here, make sure that they agreed in makeing their email
...
The program and its documentation are licensed under the terms of the
